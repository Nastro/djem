...
Ext.define('djem.view.main.MainController', {
  ...
  requires: ['djem.view.login.Login', 'djem.view.main.Content'],

  init: function() {
    var me = this, toolbar = me.lookupReference('toolbar'), tabs = me.lookupReference('tabs');
    ...
    me.lookupReference('grid').on('openDocument', function(_this, data) {
      ...
      if (!tab) {
        ...
        tab = tabs.add(Ext.create('widget.main-content', { data: data, title: title, id: tabId, closable: true }));
